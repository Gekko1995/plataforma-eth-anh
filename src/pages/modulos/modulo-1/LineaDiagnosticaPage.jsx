...
// ── Datos demo ────────────────────────────────────────────────────────
const DEMO_FICHAS = [
  { id: 'f1', municipio: 'Aguazul',       departamento: 'Casanare',          region: 'Orinoquía',    poblacion_total: 47820, actividad_economica: 'Petróleo, ganadería extensiva', presencia_institucional: ['Alcaldía', 'Gobernación', 'ANLA', 'Ecopetrol'], nivel_conflictividad: 'alto',    observaciones: 'Alta presencia de industria petrolera. Tensión por uso del suelo entre sector extractivo y comunidades campesinas.' },
  { id: 'f2', municipio: 'Yopal',         departamento: 'Casanare',          region: 'Orinoquía',    poblacion_total: 180220, actividad_economica: 'Servicios, agroindustria', presencia_institucional: ['Alcaldía', 'Gobernación', 'ANH', 'ICBF'], nivel_conflictividad: 'medio',  observaciones: 'Capital departamental con dinámicas urbanas. Crecimiento acelerado por bonanza petrolera.' },
  { id: 'f3', municipio: 'Tauramena',     departamento: 'Casanare',          region: 'Orinoquía',    poblacion_total: 20550, actividad_economica: 'Petróleo, turismo, ganadería', presencia_institucional: ['Alcaldía', 'Ecopetrol', 'Parques Nacionales'], nivel_conflictividad: 'critico', observaciones: 'Zona limítrofe con área protegida. Conflicto activo entre operación de Cusiana-Cupiagua y comunidades.' },
  { id: 'f4', municipio: 'Villanueva',    departamento: 'Casanare',          region: 'Orinoquía',    poblacion_total: 31000, actividad_economica: 'Turismo, palma africana', presencia_institucional: ['Alcaldía', 'Corporinoquia'], nivel_conflictividad: 'bajo',    observaciones: 'Potencial turístico en crecimiento. Baja conflictividad hidrocarburífera.' },
  { id: 'f5', municipio: 'Saravena',      departamento: 'Arauca',            region: 'Orinoquía',    poblacion_total: 64000, actividad_economica: 'Cacao, ganadería, petróleo', presencia_institucional: ['Alcaldía', 'Gobernación', 'Ejército Nacional', 'Defensoría'], nivel_conflictividad: 'critico', observaciones: 'Zona de presencia histórica de grupos armados. Producción cacaotera como alternativa económica.' },
  { id: 'f6', municipio: 'Puerto Gaitán', departamento: 'Meta',              region: 'Orinoquía',    poblacion_total: 19000, actividad_economica: 'Petróleo (mayor productor Colombia), ganadería', presencia_institucional: ['Alcaldía', 'Pacific Rubiales', 'ANLA', 'ANH'], nivel_conflictividad: 'alto',    observaciones: 'Municipio con mayor producción petrolera del país. Pasivos ambientales y conflictos laborales.' },
  { id: 'f7', municipio: 'Mocoa',         departamento: 'Putumayo',          region: 'Amazonia',     poblacion_total: 44000, actividad_economica: 'Petróleo, cultivos ilícitos (en reducción), ecoturismo', presencia_institucional: ['Alcaldía', 'Gobernación', 'ART', 'UNODC'], nivel_conflictividad: 'alto',    observaciones: 'Capital departamental con fuerte presencia institucional post-PNIS. Avance en sustitución de cultivos.' },
...
const DEMO_CONFLICTOS = [
  ...
  { id: 'c2',  ficha_id: 'f1', categoria: 'Social',       variable: 'Disputa por acceso a empleos locales en sector petrolero',          nivel: 'medio',   descripcion: 'Comunidades exigen cuota mínima del 30% de empleos para residentes.' },
  ...
  { id: 'c8',  ficha_id: 'f6', categoria: 'Social',       variable: 'Conflicto por canon petrolero y distribución de regalías',         nivel: 'medio',   descripcion: 'Disputa entre municipio y departamento por asignación de regalías directas.' },
      ...
      {modal && (
        <Modal title={modal === 'new' ? 'Nueva ficha territorial' : `Editar — ${modal.municipio}`} onClose={() => setModal(null)} wide>
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:14 }}>
            ...
            <div style={{ gridColumn:'1 / -1' }}><Field label="Actividad económica principal"><input className="form-input" style={INPUT} value={form.actividad_economica} onChange={e => setForm(f => ({...f, actividad_economica:e.target.value}))} placeholder="Ej: Agricultura, ganadería, petróleo" /></Field></div>
