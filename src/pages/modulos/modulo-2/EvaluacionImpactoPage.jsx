          ...
          <div style={{ display:'flex', gap:24, flexWrap:'wrap' }}>
            ...
            <div style={{ flex:'1 1 200px' }}>
              ...
              <div style={{ display:'flex', flexWrap:'wrap', gap:6 }}>
                {META.stack.map((t,i)=>(
                  <span key={i} style={{ display:'inline-flex', alignItems:'center', padding:'4px 12px', borderRadius:20, fontSize:12, fontWeight:600, background:COLOR+'12', color:COLOR, border:`1px solid ${COLOR}30` }}>{t}</span>
                ))}
              </div>
            </div>
          </div>
