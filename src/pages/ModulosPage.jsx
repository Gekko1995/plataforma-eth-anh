...
const MODULE_INFO = {
  1:  { que:'Registra cómo está el territorio antes de que el convenio llegue: cuántas familias viven allí, qué hacen, qué les hace falta y quiénes son los actores locales.',        por:'Sin una foto inicial clara del territorio no se puede medir el impacto del convenio al final. Construye la "línea de partida" que la entidad contratante exige para comparar resultados.' },
  2:  { que:'Mide los mismos indicadores en tres momentos del convenio (inicio, mitad y cierre) para demostrar qué cambió gracias a la intervención.',                                 por:'El contratante paga desembolsos contra impacto demostrable. Convierte el esfuerzo territorial en evidencia medible y comparable.' },
  3:  { que:'Pone todo el convenio en un mapa: beneficiarios, zonas PDET, ZOMAC, CARs, comunidades étnicas y puntos de operación.',                                                    por:'Las decisiones territoriales se toman mejor con el mapa a la vista. Evita errores de planificación y facilita los informes geográficos exigidos por la entidad contratante.' },
  ...
  7:  { que:'Registra y documenta todas las iniciativas sociales que el convenio ejecuta en las comunidades, con evidencia fotográfica y trazabilidad de compromisos.',                por:'Las obligaciones contractuales del convenio (cláusulas 8–10) exigen demostrar cada peso invertido en impacto social. Sin evidencia organizada el desembolso peligra.' },
  ...
  12: { que:'Certifica a todo el personal del convenio en inducción institucional, protocolos operativos, HSE y marco normativo antes de habilitarlos para operar.',                             por:'Ningún funcionario debe operar en campo sin certificación. Las obligaciones contractuales del convenio lo exigen de forma expresa.' },
  ...
  17: { que:'Recibe CVs de convocatorias públicas, los califica automáticamente con puntaje ponderado y administra el pipeline de selección hasta la vinculación.',                    por:'La transparencia en la contratación la exige el contratante y la ESAL. Deja trazabilidad completa de cada decisión del proceso.' },
  ...
  19: { que:'Hace seguimiento a las 8 CARs y entidades nacionales con las que el convenio tiene compromisos, midiendo productos entregados y estado de la alianza.',                  por:'Las obligaciones del convenio (cláusulas 12 y 13) dependen de estas alianzas. Un reporte atrasado puede comprometer el desembolso del convenio.' },
  20: { que:'Controla quién entra a la plataforma, qué puede hacer cada rol, registra toda acción con auditoría y activa MFA para roles financieros.',                                 por:'Habeas Data (Ley 1581/2012), MSPI y la entidad contratante exigen control estricto. Sin este módulo la plataforma no puede operar legalmente.' },
  ...
  24: { que:'Administra las sesiones mensuales del comité directivo del convenio: convocatorias, orden del día, actas, quórum, aprobación de subcontratos y seguimiento de compromisos.',               por:'El comité es el órgano máximo de gobernanza del convenio. Sus decisiones deben quedar documentadas con numeración y trazabilidad total.' },
  ...
  27: { que:'Recibe los informes periódicos que cada funcionario debe presentar, los revisa bajo flujo de aprobación y habilita el pago cuando están aprobados.',                      por:'Sin informe aprobado no se paga. Las obligaciones del convenio (cláusulas 9, 11 y 19) lo exigen y la ESAL requiere rendición de cuentas individual.' },
  28: { que:'Compila automáticamente los informes de rendición para los 4 desembolsos del proyecto (D1 plan, D2 35%, D3 70%, D4 final) jalando datos de múltiples módulos.',             por:'Armar un informe manual con datos de 6 módulos y 10.000 beneficiarios tomaría semanas. Automatizado toma minutos con menos errores.' },
  ...
  30: { que:'Organiza cada evento del convenio: convocatoria masiva, registro de asistencia con QR, levantamiento de actas y seguimiento de compromisos.',                             por:'Un evento sin trazabilidad no cuenta como evidencia ante el contratante. Garantiza que cada actividad en terreno quede documentada.' },
  ...
  32: { que:'Crea, organiza y archiva todas las piezas de comunicación del convenio (fotos, videos, casos de éxito) y mide su alcance digital.',                                       por:'La obligación de visibilidad del convenio exige resultados comunicables. Los casos de éxito bien documentados son activos estratégicos del convenio.' },
  ...
  34: { que:'Organiza toda la documentación del convenio en carpetas jerárquicas (Región → Municipio → Componente) con nomenclatura automática y alertas de vencimiento.',            por:'Una auditoría final con documentos dispersos es un naufragio. Mantiene el archivo ordenado y listo para la entidad contratante en todo momento.' },
  35: { que:'Lleva la trazabilidad de cada bien del convenio con QR único, GPS al momento de entrega, actas automáticas y seguimiento de ubicación mensual.',                         por:'La normativa vigente exige saber dónde está cada bien entregado. QR y georreferenciación lo resuelven con evidencia móvil.' },
  36: { que:'Gestiona todas las pólizas del convenio (cumplimiento 20%, calidad 10%, salarios 5%) con alertas automáticas a 60, 30 y 15 días antes del vencimiento.',                por:'Una póliza vencida bloquea el desembolso del proyecto sin negociación. Garantiza vigencia permanente y evita bloqueos de flujo de caja.' },
